...
const LyricsPage = () => {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.heading}>Worship Lyrics</Text>

      <Text style={styles.song_title}>Only wanna sing</Text>
      ...
      <View style={styles.lyricsBlock}>
        ...
        <Text style={styles.song_title}>Такий Великий Бог</Text>
        ...
        <Text style={styles.lyrics}>
          ...
          Нехай у радості земля Спаситель наш чекає,{'\n'}
        ...
        <Text style={styles.song_title}>Goodness of God</Text>
        ...
        <Text style={styles.lyrics}>
          ...
          Your goodness is running after, it's running after me Your goodness is running after, it's{'\n'}
          running after me{'\n\n'}
        ...
        <Text style={styles.song_title}>Ісус, Ти переміг</Text>
        ...
        <Text style={styles.song_title}>Все що я прагну</Text>

        <Text style={styles.lyrics}>
          Ти життя відав на хресті за мій гріх{'\n'}
